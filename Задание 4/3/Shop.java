    ...
    public static void main(String[] args) {
        ...
        while (shopWork) {
            ...
            if (clientChoice == 1) {
                ...
                System.out.println("1 - choose from certain company");
                System.out.println("2 - choose a certain model");
                System.out.println("3 - choose at price");
                System.out.print(">> ");
                clientChoice = src.nextInt();
                src.nextLine();
                ...
                if  (clientChoice == 1) {
                    ...
                    company = src.nextLine();
                    System.out.println("Here what I`ve found:");
                    ...
                    if (!key) System.out.println("Not founded!");
